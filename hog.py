...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    num = abs((opponent_score // 10) % 10 - player_score % 10)
    if num >= 1:
        return num * 3
    else:
        return 1
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    for num_rolls in range(1, 11):
        maximum = averaged_dice(num_rolls, dice)
        if maximum > n:
            result = num_rolls
            n = maximum
    return result
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    n = sus_update(0, score, opponent_score) - score
    if n >= threshold:
        return 0
    else:
        return num_rolls
...
def final_strategy(score, opponent_score):
    ...
    Rolling 0 whenever it would give you more points on average than rolling 6.
    """
    # BEGIN PROBLEM 12
    averaged = make_averaged(sus_update, 40)
    avg0 = averaged(0, score, opponent_score)
    avg6 = averaged(6, score, opponent_score)
    if avg0 > avg6:
        return 0
    else:
        return 6
